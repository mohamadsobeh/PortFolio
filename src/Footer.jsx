        ...
        <footer>
            <Container>
                <Row className='align-items-center'>
                    <Col md="4" sm="12">
                        <Link to="/">
                            <img src="/PortFolio/images/618b5b33c589e179c2c8b27c_Shiloh New Logo-01-p-3200.png" alt="" className="wow fadeInLeft" data-wow-duration="2s" data-wow-delay="0.5s" />
                        </Link>
                    </Col>
                    <Col md="4" sm="12">
                ...
                <div className="copyright wow fadeInUp" data-wow-duration="2s" data-wow-delay="0.5s">
                    <p>© 2023 Mohamad</p>
                    <p>Email: Mohamdsobeh1999@gmail.com</p>
                </div>
            </Container>
        </footer>
    )
